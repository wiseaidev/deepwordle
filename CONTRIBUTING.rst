...
Ready to contribute? Here's how to set up `deepwordle` for local development.

1. Fork the `deepwordle` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/deepwordle.git
